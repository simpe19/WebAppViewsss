...
namespace WebApp.Migrations.Identity
{
    ...
    [Migration("20230516130006_Seed Roles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c39cfe9d-5d5f-4b15-bf0a-f95dbe86e436",
            ...
            modelBuilder.Entity("WebApp.Contexts.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApp.Contexts.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Models.Entities.UserAdressEntity", b =>
                {
                    ...
                    b.HasOne("WebApp.Contexts.Identity.AppUser", "user")
                        .WithMany("Adresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
